...
<p>
  <img src="https://img.shields.io/badge/Version-1.9.3_Chip_Glass-34D399?style=for-the-badge&logo=git&logoColor=black" alt="Version 1.9.3" />
...
| `当前` | **v1.9.3** | **选择器玻璃化升级 (Selection Chip & Row Glass Upgrade)** | 彻底重构 SelectionChip 和 SelectionRow 底层实现，从原生 Surface 切换为 LiquidGlassSurface 体系；边框减半至 0.5.dp；未选中态去噪弱化；选中文案加粗提亮改为主题色；SelectionRow 新增 haptic 物理反馈；课表学期/周次/模式/日期选择、番茄钟时长/音色/任务绑定、偏好设置界面节奏/玻璃风格选择等全局选择器质感统一。 |
