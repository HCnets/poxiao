...
<p>
  <img src="https://img.shields.io/badge/Version-1.9.2_Button_Unity-F44?style=for-the-badge&logo=git&logoColor=black" alt="Version 1.9.2" />
...
| `当前` | **v1.9.2** | **复习计划与笔记按钮统一 (Review & Notes Button Unity)** | 彻底替换 ReviewPlannerScreen 全部 30 处原生 Button/OutlinedButton 为 ActionPill 胶囊按钮体系；统一 CourseNotesScreen 9 处笔记编辑/附件/操作按钮为 ActionPill；消除这两个高频页面的按钮风格断层，完成全局按钮体系统一。 |
