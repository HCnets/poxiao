...
<p>
  <img src="https://img.shields.io/badge/Version-1.9.4_Wheel_Glass-14B8A6?style=for-the-badge&logo=git&logoColor=black" alt="Version 1.9.4" />
...
| `当前` | **v1.9.4** | **滚轮选择器玻璃化 (WheelPicker Glass Upgrade)** | 彻底重构 WheelPicker 组件：外容器从裸 Surface 切换为 LiquidGlassSurface；滚轮条目从 1.dp 厚重 Surface 改为 0.5.dp 克制玻璃芯片（与 SelectionChip 同体系）；选中文案从白字 titleMedium 改为主色 labelLarge 加粗；未选中条目降噪弱化，视觉权重自动退后；番茄钟自定义时长分钟/秒数滚轮质感统一。 |
