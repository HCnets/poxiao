...
随着架构解耦的推进，本仓库对代码结构进行了版本快照隔离。详细切换方式请参考 [📖 版本说明文档](docs/版本说明.md)。

| 分支 / 标签 | 状态 | 适用场景 |
| :--- | :--- | :--- |
| `main` | **[当前维护主线]** 拆分完成版 | 日常功能开发、UI 迭代。工程已解耦，各页面拥有独立的逻辑文件。 |
| `archive-monolithic` | **[历史归档]** 未拆分单文件版 | 查看历史重构前的全量代码，了解拆分前状态。不再接收新功能。 |
| `monolithic-baseline` | **[基线标签]** 重构前最后锚点 | 精确对比拆分前后的架构差异，或者需要回滚重构时使用。 |
